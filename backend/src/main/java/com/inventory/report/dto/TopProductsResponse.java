...
/**
 * DTO de respuesta con el ranking de los N productos activos con mayor inventario. Informa el
 * límite aplicado, la métrica de ordenamiento usada ({@code value} o {@code quantity}) y la lista
 * de productos ordenados de mayor a menor.
 */
