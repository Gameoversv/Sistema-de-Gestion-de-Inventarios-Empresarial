...
El frontend se mide aparte y está en **9,6 %** de líneas. El informe daba 100 % hasta que se configuró `coverage.include` en vitest: solo contaba las 14 sentencias que los tests importaban. Es el hueco de calidad conocido y declarado.
